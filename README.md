# Kotlin Tasks Android 📱
    ...
    <p align="center">
    <img src="screenshots/screen_task_list.png" width="30%" alt="Lista de Tarefas" />
    &nbsp;&nbsp;
    <img src="screenshots/screen_create_task.png" width="30%" alt="Criar Nova Tarefa" />
    &nbsp;&nbsp;
    <img src="screenshots/screen_filter_priority.png" width="30%" alt="Filtro por Prioridade" />
    </p>

    <p align="center">
    <em>Lista de tarefas &nbsp;&nbsp;·&nbsp;&nbsp; Criação de tarefa &nbsp;&nbsp;·&nbsp;&nbsp; Filtro por prioridade</em>
    </p>
